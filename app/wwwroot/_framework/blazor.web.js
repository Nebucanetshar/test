(() => {
    ...
    ///<summary>
    /// fonction(e) (fonction primaire de blazor.web.js mettent en fonction c'est différente constantes (e, t, ...n))
    ///</summary >
        function (e) {
            const t = []
                , n = "__jsObjectId"
            ...
            ///<summary>
            /// instanciation de la class y (invocation .Net methode) dans la methode d'attachDispatcher avec e
            ///</summary >
            ...
            ///<summary>
            /// classe d'invocation des methodes .Net
            ///</summary >
            class y {
                constructor(e) {
                ...
                beginInvokeJSFromDotNet(e, t, n, o, r) {
                    ...
                    e && i.then((t => T(this, [e, !0, I(t, o)]))).then((t => this._dotNetCallDispatcher.endInvokeJSFromDotNet(e, !0, t)), (t => this._dotNetCallDispatcher.endInvokeJSFromDotNet(e, !1, JSON.stringify([e, !1, w(t)]))))
                }
                ...
                ///<summary>
                /// interopatibilité entre le client js et le code c# du runtime .Net, plçage d'un point d'arrêt 
                /// d'éxécution du script pour ouvrir le debogueur avec une journalisation 
                ///</summary >
                invokeDotNetStaticMethodAsync(e, t, ...n) {
                    debugger;
                    console.log("test", (e, t, ...n))
            ...
            e.findJSFunction = b,
                e.disposeJSObjectReferenceById = _;
            class S {
                constructor(e, t) {
                    this._id = e,
    ...
    let D = (e, t, n) => n();
    const x = B(["abort", "blur", "cancel", "canplay", "canplaythrough", "change", "close", "cuechange", "durationchange", "emptied", "ended", "error", "focus", "load", "loadeddata", "loadedmetadata", "loadend", "loadstart", "mouseenter", "mouseleave", "pointerenter", "pointerleave", "pause", "play", "playing", "progress", "ratechange", "reset", "scroll", "seeked", "seeking", "stalled", "submit", "suspend", "timeupdate", "toggle", "unload", "volumechange", "waiting", "DOMNodeInsertedIntoDocument", "DOMNodeRemovedFromDocument"])
        , N = {
            submit: !0
        }
            ...
            for (; o;) {
                ...
                if (p) {
                    ...
                    if (n && (h = u,
                        ...
                        Object.prototype.hasOwnProperty.call(N, t.type) && t.preventDefault(),
                            R(this.browserRendererId, {
    ...
    e.attachReviver(((e, t) => t && "object" == typeof t && Object.prototype.hasOwnProperty.call(t, ie) && "string" == typeof t[ie] ? function (e) {
        const t = `[${re(e)}]`;
    ...
    class ve {
        ...
        updateComponent(e, t, n, o) {
            ...
            fe.delete(i) && (j(i),
                i instanceof Comment && (i.textContent = "!"));
            const s = null === (r = te(i)) || void 0 === r ? void 0 : r.getRootNode()
                , a = s && s.activeElement;
            this.applyEdits(e, t, i, 0, n, o),
                a instanceof HTMLElement && s && s.activeElement !== a && a.focus()
        }
        disposeComponent(e) {
        ...
        insertElement(e, t, o, r, i, s, a) {
            const c = e.frameReader
                , l = c.elementName(s)
                , h = "svg" === l || G(o) ? document.createElementNS("http://www.w3.org/2000/svg", l) : document.createElement(l)
                , d = W(h);
            let u = !1;
                    ...
                    case "value":
                        return function (e, t) {
                            ...
                            e.tagName) {
                                ...
                                case "SELECT":
                                case "TEXTAREA":
                                    return t && e instanceof HTMLSelectElement && ce(e) && (t = JSON.parse(t)),
                                        he(e, t),
                                        e[se] = t,
                                        !0;
                                case "OPTION":
    ...
    function Ne(e, t) {
        ...
        if (n && function (e) {
            ...
            const o = Fe(n.getAttribute("href"));
            Me(o) && (e.preventDefault(),
                t(o))
        }
    }
    function Me(e) {
        ...
        listenForNavigationEvents: function (e, t, n) {
            ...
            qe.set(e, {
                ...
                We || (We = !0,
                    ...
                    je = null !== (r = null === (o = history.state) || void 0 === o ? void 0 : o._index) && void 0 !== r ? r : 0,
                    ke = (e, t) => {
                        tt(t, e)
                    }
                )
    ...
    function Xe(e, t, n = !1) {
        const o = Fe(e)
            , r = rt();
        if (t.forceLoad || !Me(o) || "serverside-fullpageload" === r)
            !function (e, t) {
                if (location.href === e) {
                    const t = e + "?";
        ...
        else if ("clientside-router" === r)
            Ge(o, !1, t.replaceHistoryEntry, t.historyEntryState, n);
        else {
            if ("serverside-enhanced" !== r)
                throw new Error(`Unsupported page load mechanism: ${r}`);
    ...
    async function Ge(e, t, n, o = void 0, r = !1) {
        if (Ze(),
            ...
            return Ye(e, n, o),
                void Ue(e);
        const i = ot();
        (r || !(null == i ? void 0 : i.hasLocationChangingEventListeners) || await et(e, o, t, i)) && (Re = !0,
            Ye(e, n, o),
            await tt(t))
    }
    ...
    function et(e, t, n, o) {
        return new Promise((r => {
            Ze(),
                ze++,
                Ke = r,
                o.locationChanging(ze, e, t, n)
        }
        ))
    }
    async function tt(e, t) {
        const n = null != t ? t : location.href;
        await Promise.all(Array.from(qe, (async ([t, o]) => {
            var r;
    ...
    async function nt(e) {
        var t, n;
        Je && "serverside-enhanced" !== rt() && await Je(e),
            je = null !== (n = null === (t = history.state) || void 0 === t ? void 0 : t._index) && void 0 !== n ? n : 0
    }
    function ot() {
        const e = He();
        if (void 0 !== e)
    ...
    function rt() {
        return $e() ? "clientside-router" : Be() ? "serverside-enhanced" : window.Blazor._internal.isBlazorWeb ? "serverside-fullpageload" : "clientside-router"
    }
    const it = {
        focus: function (e, t) {
            ...
            init: function (e, t, n, o = 50) {
                ...
                const s = new IntersectionObserver((function (o) {
                    o.forEach((o => {
                        ...
                        o.target === t ? e.invokeMethodAsync("OnSpacerBeforeVisible", o.intersectionRect.top - o.boundingClientRect.top, s, a) : o.target === n && n.offsetHeight > 0 && e.invokeMethodAsync("OnSpacerAfterVisible", o.boundingClientRect.bottom - o.intersectionRect.bottom, s, a)
                    }
                    ))
                }
                ), {
        ...
        , at = Symbol();
    function ct(e) {
        return e && e !== document.body && e !== document.documentElement ? "visible" !== getComputedStyle(e).overflowY ? e : ct(e.parentElement) : null
    }
    function lt(e) {
        var t;
        const n = e._callDispatcher
            , o = e._id;
        return null !== (t = n[at]) && void 0 !== t || (n[at] = {}),
        {
            observersByDotNetObjectId: n[at],
            id: o
        }
    }
    const ht = {
        getAndRemoveExistingTitle: function () {
            ...
            for (let o = t.length - 1; o >= 0; o--) {
                const r = t[o]
                    , i = r.previousSibling;
                i instanceof Comment && null !== K(i) || (null === n && (n = r.textContent),
                ...
                const i = ut(e, t)
                    ...
                    , a = await new Promise((function (e) {
                        ...
                        l.width = Math.round(s.width * c),
                            ...
                            null === (t = l.getContext("2d")) || void 0 === t || t.drawImage(s, 0, 0, l.width, l.height),
                            l.toBlob(e, n)
                    }
                    ))
                    , c = {
    ...
    const pt = new Set
        , ft = {
            enableNavigationPrompt: function (e) {
                0 === pt.size && window.addEventListener("beforeunload", gt),
                    pt.add(e)
            },
    ...
    function St(e, t) {
        switch (t) {
            case "webassembly":
                return Rt(e, "webassembly");
            case "server":
                return function (e) {
                    return Rt(e, "server").sort(((e, t) => e.sequence - t.sequence))
                }(e);
            case "auto":
                return Rt(e, "auto")
        }
    }
    const Ct = /^\s*Blazor-Server-Component-State:(?<state>[a-zA-Z0-9+/=]+)$/
        , Et = /^\s*Blazor-WebAssembly-Component-State:(?<state>[a-zA-Z0-9+/=]+)$/
        , It = /^\s*Blazor-Web-Initializers:(?<initializers>[a-zA-Z0-9+/=]+)$/;
    function kt(e) {
        return Tt(e, Ct)
    }
    function Tt(e, t, n = "state") {
        ...
        if (e.nodeType === Node.COMMENT_NODE) {
            ...
            return s && (null === (o = e.parentNode) || void 0 === o || o.removeChild(e)),
                s
        }
        if (!e.hasChildNodes())
            return;
    ...
    class Ot {
        static write(e) {
            return `${e}${Ot.RecordSeparator}`
        }
        static parse(e) {
            if (e[e.length - 1] !== Ot.RecordSeparator)
                throw new Error("Message is incomplete.");
            const t = e.split(Ot.RecordSeparator);
            return t.pop(),
                t
        }
    }
    var Ft;
    Ot.RecordSeparatorCode = 30,
        Ot.RecordSeparator = String.fromCharCode(Ot.RecordSeparatorCode),
        function (e) {
            e[e.Trace = 0] = "Trace",
                e[e.Debug = 1] = "Debug",
                e[e.Information = 2] = "Information",
    ...
    class jt {
        static get isBrowser() {
            return !jt.isNode && "object" == typeof window && "object" == typeof window.document
        }
        static get isWebWorker() {
            return !jt.isNode && "object" == typeof self && "importScripts" in self
        }
        static get isReactNative() {
            return !jt.isNode && "object" == typeof window && void 0 === window.document
        }
        static get isNode() {
    ...
    function zt(e, t) {
        let n = "";
        return qt(e) ? (n = `Binary data of length ${e.byteLength}`,
    ...
    async function Jt(e, t, n, o, r, i) {
        const s = {}
            , [a, c] = Xt();
        s[a] = c,
            e.log(Ft.Trace, `(${t} transport) sending data. ${zt(r, i.logMessageContent)}.`);
        const l = qt(r) ? "arraybuffer" : "text"
            , h = await n.post(o, {
                content: r,
                headers: {
                    ...s,
        ...
        e.log(Ft.Trace, `(${t} transport) request complete. Response status: ${h.statusCode}.`)
    }
    class Kt {
        constructor(e, t) {
            this._subject = e,
    ...
    class Vt {
        ...
        log(e, t) {
            if (e >= this._minLevel) {
                const n = `[${(new Date).toISOString()}] ${Ft[e]}: ${t}`;
                switch (e) {
                    case Ft.Critical:
                    case Ft.Error:
                        this.out.error(n);
    ...
    function Xt() {
        ...
        return jt.isNode && (e = "User-Agent"),
            [e, Gt(Ht, Yt(), jt.isNode ? "NodeJS" : "Browser", Qt())]
    }
    function Gt(e, t, n, o) {
        ...
        parseHandshakeResponse(e) {
            ...
            if (qt(e)) {
                const o = new Uint8Array(e)
                    , r = o.indexOf(Ot.RecordSeparatorCode);
                if (-1 === r)
                    throw new Error("Message is incomplete.");
                const i = r + 1;
                ...
                const o = e
                    , r = o.indexOf(Ot.RecordSeparator);
                if (-1 === r)
                    throw new Error("Message is incomplete.");
                const i = r + 1;
                t = o.substring(0, i),
    ...
    class pn {
        ...
        async _send(e) {
            ...
            if (this._isInvocationMessage(e)) {
                ...
                let e = () => { }
                    , o = () => { }
                    ;
                qt(t) ? this._bufferedByteCount += t.byteLength : this._bufferedByteCount += t.length,
                    this._bufferedByteCount >= this._bufferSize && (n = new Promise(((t, n) => {
                        e = t,
                            o = n
                    }
                    ))),
                    this._messages.push(new fn(t, this._totalMessageCount, e, o))
            }
            try {
        ...
        _ack(e) {
            ...
            for (let n = 0; n < this._messages.length; n++) {
                ...
                if (o._id <= e.sequenceId)
                    t = n,
                        qt(o._message) ? this._bufferedByteCount -= o._message.byteLength : this._bufferedByteCount -= o._message.length,
                        o._resolver();
                else {
        ...
        _shouldProcessMessage(e) {
            if (this._waitForSequenceMessage)
                return e.type === hn.Sequence && (this._waitForSequenceMessage = !1,
                    !0);
            if (!this._isInvocationMessage(e))
                return !0;
        ...
        _isInvocationMessage(e) {
            switch (e.type) {
                ...
                case hn.StreamItem:
                case hn.Completion:
                case hn.StreamInvocation:
                case hn.CancelInvocation:
                    return !0;
                case hn.Close:
                case hn.Sequence:
                case hn.Ping:
    ...
    class gn {
        static create(e, t, n, o, r, i, s) {
            return new gn(e, t, n, o, r, i, s)
        }
        constructor(e, t, n, o, r, i, s) {
            this._nextKeepAlive = 0,
                this._freezeEventListener = () => {
                    this._logger.log(Ft.Warning, "The page is being frozen, this will likely lead to the connection being closed and messages being lost. For more information see the docs at https://learn.microsoft.com/aspnet/core/signalr/javascript-client#bsleep")
                }
                ,
                Wt.isRequired(e, "connection"),
                Wt.isRequired(t, "logger"),
                Wt.isRequired(n, "protocol"),
                ...
                this._handshakeProtocol = new en,
                ...
                this._connectionState = dn.Disconnected,
        ...
        set baseUrl(e) {
            if (this._connectionState !== dn.Disconnected && this._connectionState !== dn.Reconnecting)
        ...
        async _startWithStateTransitions() {
            if (this._connectionState !== dn.Disconnected)
                return Promise.reject(new Error("Cannot start a HubConnection that is not in the 'Disconnected' state."));
            this._connectionState = dn.Connecting,
                this._logger.log(Ft.Debug, "Starting HubConnection.");
            try {
                await this._startInternal(),
                    jt.isBrowser && window.document.addEventListener("freeze", this._freezeEventListener),
                    this._connectionState = dn.Connected,
                    this._connectionStarted = !0,
                    this._logger.log(Ft.Debug, "HubConnection connected successfully.")
            } catch (e) {
                return this._connectionState = dn.Disconnected,
                    this._logger.log(Ft.Debug, `HubConnection failed to start successfully because of error '${e}'.`),
                    Promise.reject(e)
            }
        }
        async _startInternal() {
            ...
            try {
                ...
                if (this._logger.log(Ft.Debug, "Sending handshake request."),
                    await this._sendMessage(this._handshakeProtocol.writeHandshakeRequest(n)),
                    this._logger.log(Ft.Information, `Using HubProtocol '${this._protocol.name}'.`),
                ...
                !!this.connection.features.reconnect && (this._messageBuffer = new pn(this._protocol, this.connection, this._statefulReconnectBufferSize),
                ...
                throw this._logger.log(Ft.Debug, `Hub handshake failed with error '${e}' during start(). Stopping HubConnection.`),
                this._cleanupTimeout(),
        ...
        _stopInternal(e) {
            if (this._connectionState === dn.Disconnected)
                return this._logger.log(Ft.Debug, `Call to HubConnection.stop(${e}) ignored because it is already in the disconnected state.`),
                    Promise.resolve();
            if (this._connectionState === dn.Disconnecting)
                return this._logger.log(Ft.Debug, `Call to HttpConnection.stop(${e}) ignored because the connection is already in the disconnecting state.`),
                    this._stopPromise;
            const t = this._connectionState;
            return this._connectionState = dn.Disconnecting,
                this._logger.log(Ft.Debug, "Stopping HubConnection."),
                this._reconnectDelayHandle ? (this._logger.log(Ft.Debug, "Connection stopped during reconnect delay. Done reconnecting."),
                    clearTimeout(this._reconnectDelayHandle),
                    this._reconnectDelayHandle = void 0,
                    this._completeClose(),
                    Promise.resolve()) : (t === dn.Connected && this._sendCloseMessage(),
                        this._cleanupTimeout(),
                        this._cleanupPingTimer(),
                        this._stopDuringStartError = e || new on("The connection was stopped before the hub handshake could complete."),
        ...
        invoke(e, ...t) {
            ...
            return new Promise(((e, t) => {
                this._callbacks[r.invocationId] = (n, o) => {
                    o ? t(o) : n && (n.type === hn.Completion ? n.error ? t(new Error(n.error)) : e(n.result) : t(new Error(`Unexpected message type: ${n.type}`)))
                }
                    ;
                        ...
                        switch (e.type) {
                            case hn.Invocation:
                                this._invokeClientMethod(e).catch((e => {
                                    this._logger.log(Ft.Error, `Invoke client method threw error: ${Zt(e)}`)
                                }
                                ));
                                break;
                            case hn.StreamItem:
                            case hn.Completion:
                                {
                                    ...
                                    if (t) {
                                        ...
                                        try {
                                            ...
                                            this._logger.log(Ft.Error, `Stream callback threw error: ${Zt(e)}`)
                                        }
                                    }
                                    break
                                }
                            ...
                            case hn.Close:
                                {
                                    this._logger.log(Ft.Information, "Close message received from server.");
                            ...
                            case hn.Sequence:
                                ...
                                break;
                            default:
                                this._logger.log(Ft.Warning, `Invalid message type: ${e.type}.`)
                        }
            }
            this._resetTimeoutPeriod()
        }
        _processHandshakeResponse(e) {
            ...
            if (t.error) {
                ...
                this._logger.log(Ft.Error, e);
                const n = new Error(e);
                throw this._handshakeRejecter(n),
                n
            }
            return this._logger.log(Ft.Debug, "Server handshake complete."),
            ...
            if (!(this.connection.features && this.connection.features.inherentKeepAlive || (this._timeoutHandle = setTimeout((() => this.serverTimeout()), this.serverTimeoutInMilliseconds),
                ...
                e < 0 && (e = 0),
                    this._pingServerHandle = setTimeout((async () => {
                        if (this._connectionState === dn.Connected)
                            try {
        ...
        async _invokeClientMethod(e) {
            const t = e.target.toLowerCase()
                , n = this._methods[t];
            if (!n)
                return this._logger.log(Ft.Warning, `No client method with the name '${t}' found.`),
                    void (e.invocationId && (this._logger.log(Ft.Warning, `No result given for '${t}' method and invocation ID '${e.invocationId}'.`),
            ...
            for (const n of o)
                try {
                    ...
                    i = await n.apply(this, e.arguments),
                        r && i && o && (this._logger.log(Ft.Error, `Multiple results provided for '${t}'. Sending error to server.`),
                            a = this._createCompletionMessage(e.invocationId, "Client provided multiple results.", null)),
                        s = void 0
                } catch (e) {
                    s = e,
                        this._logger.log(Ft.Error, `A callback for the method '${t}' threw error '${e}'.`)
                }
            a ? await this._sendWithProtocol(a) : r ? (s ? a = this._createCompletionMessage(e.invocationId, `${s}`, null) : void 0 !== i ? a = this._createCompletionMessage(e.invocationId, null, i) : (this._logger.log(Ft.Warning, `No result given for '${t}' method and invocation ID '${e.invocationId}'.`),
                a = this._createCompletionMessage(e.invocationId, "Client didn't provide a result.", null)),
                await this._sendWithProtocol(a)) : i && this._logger.log(Ft.Error, `Result given for '${t}' method but server is not expecting a result.`)
        }
        _connectionClosed(e) {
            this._logger.log(Ft.Debug, `HubConnection.connectionClosed(${e}) called while in state ${this._connectionState}.`),
                this._stopDuringStartError = this._stopDuringStartError || e || new on("The underlying connection was closed before the hub handshake could complete."),
                ...
                this._cleanupTimeout(),
                this._cleanupPingTimer(),
                this._connectionState === dn.Disconnecting ? this._completeClose(e) : this._connectionState === dn.Connected && this._reconnectPolicy ? this._reconnect(e) : this._connectionState === dn.Connected && this._completeClose(e)
        }
        _completeClose(e) {
            if (this._connectionStarted) {
                this._connectionState = dn.Disconnected,
                    ...
                    jt.isBrowser && window.document.removeEventListener("freeze", this._freezeEventListener);
                try {
                    this._closedCallbacks.forEach((t => t.apply(this, [e])))
                } catch (t) {
                    this._logger.log(Ft.Error, `An onclose callback called with error '${e}' threw error '${t}'.`)
                }
            }
        }
        async _reconnect(e) {
            ...
            if (null === r)
                return this._logger.log(Ft.Debug, "Connection not reconnecting because the IRetryPolicy returned null on the first reconnect attempt."),
                    void this._completeClose(e);
            if (this._connectionState = dn.Reconnecting,
                e ? this._logger.log(Ft.Information, `Connection reconnecting because of error '${e}'.`) : this._logger.log(Ft.Information, "Connection reconnecting."),
                0 !== this._reconnectingCallbacks.length) {
                try {
                    this._reconnectingCallbacks.forEach((t => t.apply(this, [e])))
                } catch (t) {
                    this._logger.log(Ft.Error, `An onreconnecting callback called with error '${e}' threw error '${t}'.`)
                }
                if (this._connectionState !== dn.Reconnecting)
                    return void this._logger.log(Ft.Debug, "Connection left the reconnecting state in onreconnecting callback. Done reconnecting.")
            }
            for (; null !== r;) {
                if (this._logger.log(Ft.Information, `Reconnect attempt number ${n} will start in ${r} ms.`),
                    await new Promise((e => {
                        this._reconnectDelayHandle = setTimeout(e, r)
                    }
                    )),
                    this._reconnectDelayHandle = void 0,
                    this._connectionState !== dn.Reconnecting)
                    return void this._logger.log(Ft.Debug, "Connection left the reconnecting state during reconnect delay. Done reconnecting.");
                try {
                    if (await this._startInternal(),
                        this._connectionState = dn.Connected,
                        this._logger.log(Ft.Information, "HubConnection reconnected successfully."),
                        0 !== this._reconnectedCallbacks.length)
                        try {
                            this._reconnectedCallbacks.forEach((e => e.apply(this, [this.connection.connectionId])))
                        } catch (e) {
                            this._logger.log(Ft.Error, `An onreconnected callback called with connectionId '${this.connection.connectionId}; threw error '${e}'.`)
                        }
                    return
                } catch (e) {
                    if (this._logger.log(Ft.Information, `Reconnect attempt failed because of error '${e}'.`),
                        this._connectionState !== dn.Reconnecting)
                        return this._logger.log(Ft.Debug, `Connection moved to the '${this._connectionState}' from the reconnecting state during reconnect attempt. Done reconnecting.`),
            ...
            this._logger.log(Ft.Information, `Reconnect retries have been exhausted after ${Date.now() - t} ms and ${n} failed attempts. Connection disconnecting.`),
                this._completeClose()
        }
        _getNextRetryDelay(e, t, n) {
            try {
                ...
                return this._logger.log(Ft.Error, `IRetryPolicy.nextRetryDelayInMilliseconds(${e}, ${t}) threw error '${n}'.`),
                    null
            }
        }
            ...
            this._callbacks = {},
                Object.keys(t).forEach((n => {
                    ...
                    try {
                        ...
                        this._logger.log(Ft.Error, `Stream 'error' callback called with '${e}' threw error: ${Zt(t)}`)
                    }
                }
                ))
        }
    ...
    const mn = [0, 2e3, 1e4, 3e4, null];
    class vn {
        constructor(e) {
            this._retryDelays = void 0 !== e ? [...e, null] : mn
        }
    ...
    yn.Authorization = "Authorization",
        yn.Cookie = "Cookie";
    class wn {
        constructor(e, t, n) {
            this.statusCode = e,
    ...
    class _n extends bn {
        ...
        _setAuthorizationHeader(e) {
            e.headers || (e.headers = {}),
                this._accessToken ? e.headers[yn.Authorization] = `Bearer ${this._accessToken}` : this._accessTokenFactory && e.headers[yn.Authorization] && delete e.headers[yn.Authorization]
        }
        getCookieString(e) {
    ...
    class Sn extends bn {
        ...
        async send(e) {
            ...
            if (e.timeout) {
                ...
                r = setTimeout((() => {
                    t.abort(),
                        this._logger.log(Ft.Warning, "Timeout from HTTP request."),
                        n = new nn
                }
                ), o)
            }
            "" === e.content && (e.content = void 0),
                e.content && (e.headers = e.headers || {},
                    qt(e.content) ? e.headers["Content-Type"] = "application/octet-stream" : e.headers["Content-Type"] = "text/plain;charset=UTF-8");
            try {
                ...
                if (n)
                    throw n;
                throw this._logger.log(Ft.Warning, `Error from HTTP request. ${e}.`),
                e
            } finally {
                r && clearTimeout(r),
            ...
            if (!o.ok) {
                ...
                throw new tn(e || o.statusText, o.status)
            }
            const i = Cn(o, e.responseType)
                , s = await i;
            return new wn(o.status, o.statusText, s)
        }
        getCookieString(e) {
            return ""
        }
    ...
    class En extends bn {
        ...
        send(e) {
            return e.abortSignal && e.abortSignal.aborted ? Promise.reject(new on) : e.method ? e.url ? new Promise(((t, n) => {
                const o = new XMLHttpRequest;
                o.open(e.method, e.url, !0),
                    o.withCredentials = void 0 === e.withCredentials || e.withCredentials,
                    o.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
                    "" === e.content && (e.content = void 0),
                    e.content && (qt(e.content) ? o.setRequestHeader("Content-Type", "application/octet-stream") : o.setRequestHeader("Content-Type", "text/plain;charset=UTF-8"));
                const r = e.headers;
                r && Object.keys(r).forEach((e => {
                    ...
                    o.onload = () => {
                        e.abortSignal && (e.abortSignal.onabort = null),
                            o.status >= 200 && o.status < 300 ? t(new wn(o.status, o.statusText, o.response || o.responseText)) : n(new tn(o.response || o.responseText || o.statusText, o.status))
                    }
                    ,
                    o.onerror = () => {
                        this._logger.log(Ft.Warning, `Error from HTTP request. ${o.status}: ${o.statusText}.`),
                            n(new tn(o.statusText, o.status))
                    }
                    ,
                    o.ontimeout = () => {
                        this._logger.log(Ft.Warning, "Timeout from HTTP request."),
    ...
    class An {
        ...
        async connect(e, t) {
            if (Wt.isRequired(e, "url"),
                Wt.isRequired(t, "transferFormat"),
                Wt.isIn(t, Tn, "transferFormat"),
                this._url = e,
                this._logger.log(Ft.Trace, "(LongPolling transport) Connecting."),
                t === Tn.Binary && "undefined" != typeof XMLHttpRequest && "string" != typeof (new XMLHttpRequest).responseType)
            ...
            t === Tn.Binary && (i.responseType = "arraybuffer");
            const s = `${e}&_=${Date.now()}`;
            this._logger.log(Ft.Trace, `(LongPolling transport) polling: ${s}.`);
            const a = await this._httpClient.get(s, i);
            200 !== a.statusCode ? (this._logger.log(Ft.Error, `(LongPolling transport) Unexpected response code: ${a.statusCode}.`),
                this._closeError = new tn(a.statusText || "", a.statusCode),
            ...
            try {
                for (; this._running;)
                    try {
                        ...
                        this._logger.log(Ft.Trace, `(LongPolling transport) polling: ${n}.`);
                        const o = await this._httpClient.get(n, t);
                        204 === o.statusCode ? (this._logger.log(Ft.Information, "(LongPolling transport) Poll terminated by server."),
                            this._running = !1) : 200 !== o.statusCode ? (this._logger.log(Ft.Error, `(LongPolling transport) Unexpected response code: ${o.statusCode}.`),
                                this._closeError = new tn(o.statusText || "", o.statusCode),
                                this._running = !1) : o.content ? (this._logger.log(Ft.Trace, `(LongPolling transport) data received. ${zt(o.content, this._options.logMessageContent)}.`),
                                    this.onreceive && this.onreceive(o.content)) : this._logger.log(Ft.Trace, "(LongPolling transport) Poll timed out, reissuing.")
                    } catch (e) {
                        this._running ? e instanceof nn ? this._logger.log(Ft.Trace, "(LongPolling transport) Poll timed out, reissuing.") : (this._closeError = e,
                            this._running = !1) : this._logger.log(Ft.Trace, `(LongPolling transport) Poll errored after shutdown: ${e.message}`)
                    }
            } finally {
                this._logger.log(Ft.Trace, "(LongPolling transport) Polling complete."),
                    this.pollAborted || this._raiseOnClose()
            }
        }
        async send(e) {
            return this._running ? Jt(this._logger, "LongPolling", this._httpClient, this._url, e, this._options) : Promise.reject(new Error("Cannot send until the transport is connected"))
        }
        async stop() {
            this._logger.log(Ft.Trace, "(LongPolling transport) Stopping polling."),
                this._running = !1,
                this._pollAbort.abort();
            try {
                await this._receiving,
                    this._logger.log(Ft.Trace, `(LongPolling transport) sending DELETE request to ${this._url}.`);
                const e = {}
                    , [t, n] = Xt();
                e[t] = n;
                const o = {
                ...
                r ? r instanceof tn && (404 === r.statusCode ? this._logger.log(Ft.Trace, "(LongPolling transport) A 404 response was returned from sending a DELETE request.") : this._logger.log(Ft.Trace, `(LongPolling transport) Error sending a DELETE request: ${r}`)) : this._logger.log(Ft.Trace, "(LongPolling transport) DELETE request accepted.")
            } finally {
                this._logger.log(Ft.Trace, "(LongPolling transport) Stop finished."),
                    this._raiseOnClose()
            }
        }
        _raiseOnClose() {
    ...
    class Dn {
        ...
        async connect(e, t) {
            return Wt.isRequired(e, "url"),
                Wt.isRequired(t, "transferFormat"),
                Wt.isIn(t, Tn, "transferFormat"),
                this._logger.log(Ft.Trace, "(SSE transport) Connecting."),
                this._url = e,
                this._accessToken && (e += (e.indexOf("?") < 0 ? "?" : "&") + `access_token=${encodeURIComponent(this._accessToken)}`),
                new Promise(((n, o) => {
                    let r, i = !1;
                    if (t === Tn.Text) {
                        if (jt.isBrowser || jt.isWebWorker)
                        ...
                        try {
                            r.onmessage = e => {
                                if (this.onreceive)
                                    try {
                                        this._logger.log(Ft.Trace, `(SSE transport) data received. ${zt(e.data, this._options.logMessageContent)}.`),
                                ...
                                ,
                                r.onopen = () => {
                                    this._logger.log(Ft.Information, `SSE connected to ${this._url}`),
                                        this._eventSource = r,
                                        i = !0,
                                        n()
                                }
        ...
        async send(e) {
            return this._eventSource ? Jt(this._logger, "SSE", this._httpClient, this._url, e, this._options) : Promise.reject(new Error("Cannot send until the transport is connected"))
        }
        stop() {
            return this._close(),
                Promise.resolve()
    ...
    class xn {
        ...
        async connect(e, t) {
            ...
            return Wt.isRequired(e, "url"),
                Wt.isRequired(t, "transferFormat"),
                Wt.isIn(t, Tn, "transferFormat"),
                this._logger.log(Ft.Trace, "(WebSockets transport) Connecting."),
                ...
                new Promise(((o, r) => {
                    ...
                    i || (i = new this._webSocketConstructor(e)),
                        t === Tn.Binary && (i.binaryType = "arraybuffer"),
                        i.onopen = t => {
                            this._logger.log(Ft.Information, `WebSocket connected to ${e}.`),
                                this._webSocket = i,
                                a = !0,
                                o()
                        }
                        ...
                        i.onerror = e => {
                            ...
                            t = "undefined" != typeof ErrorEvent && e instanceof ErrorEvent ? e.error : "There was an error with the transport",
                                this._logger.log(Ft.Information, `(WebSockets transport) ${t}.`)
                        }
                        ,
                        i.onmessage = e => {
                            if (this._logger.log(Ft.Trace, `(WebSockets transport) data received. ${zt(e.data, this._logMessageContent)}.`),
                                this.onreceive)
                                try {
                                    this.onreceive(e.data)
                                } catch (e) {
        ...
        send(e) {
            return this._webSocket && this._webSocket.readyState === this._webSocketConstructor.OPEN ? (this._logger.log(Ft.Trace, `(WebSockets transport) sending data. ${zt(e, this._logMessageContent)}.`),
        ...
        _close(e) {
            this._webSocket && (this._webSocket.onclose = () => { }
                ...
                this._logger.log(Ft.Trace, "(WebSockets transport) socket closed."),
    ...
    class Nn {
        constructor(e, t = {}) {
            if (this._stopPromiseResolver = () => { }
                ...
                this._logger = function (e) {
                    return void 0 === e ? new Vt(Ft.Information) : null === e ? $t.instance : void 0 !== e.log ? e : new Vt(e)
                }(t.logger),
            ...
            t.withCredentials = void 0 === t.withCredentials || t.withCredentials,
                ...
                this._httpClient = new _n(t.httpClient || new In(this._logger), t.accessTokenFactory),
        ...
        async start(e) {
            if (e = e || Tn.Binary,
                Wt.isIn(e, Tn, "transferFormat"),
                this._logger.log(Ft.Debug, `Starting connection with transfer format '${Tn[e]}'.`),
            ...
            if (this._connectionState = "Connecting",
                ...
                return this._logger.log(Ft.Error, e),
                    await this._stopPromise,
                    Promise.reject(new on(e))
            }
        ...
        send(e) {
            return "Connected" !== this._connectionState ? Promise.reject(new Error("Cannot send data if the connection is not in the 'Connected' State.")) : (this._sendQueue || (this._sendQueue = new Mn(this.transport)),
                this._sendQueue.send(e))
        }
        async stop(e) {
            return "Disconnected" === this._connectionState ? (this._logger.log(Ft.Debug, `Call to HttpConnection.stop(${e}) ignored because the connection is already in the disconnected state.`),
                Promise.resolve()) : "Disconnecting" === this._connectionState ? (this._logger.log(Ft.Debug, `Call to HttpConnection.stop(${e}) ignored because the connection is already in the disconnecting state.`),
        ...
        async _stopInternal(e) {
            ...
            if (this.transport) {
                try {
                    ...
                    this._logger.log(Ft.Error, `HttpConnection.transport.stop() threw error '${e}'.`),
                        this._stopConnection()
                }
                this.transport = void 0
            } else
                this._logger.log(Ft.Debug, "HttpConnection.transport is undefined in HttpConnection.stop() because start() failed.")
        }
        async _startInternal(e) {
            ...
            try {
                if (this._options.skipNegotiation) {
                    if (this._options.transport !== kn.WebSockets)
                        throw new Error("Negotiation can only be skipped when using the WebSocket transport directly.");
                    this.transport = this._constructTransport(kn.WebSockets),
                    ...
                    do {
                        if (n = await this._getNegotiationResponse(t),
                            ...
                            throw new on("The connection was stopped during negotiation.");
                        if (n.error)
                ...
                this.transport instanceof An && (this.features.inherentKeepAlive = !0),
                    "Connecting" === this._connectionState && (this._logger.log(Ft.Debug, "The HttpConnection connected successfully."),
                        this._connectionState = "Connected")
            } catch (e) {
                return this._logger.log(Ft.Error, "Failed to start the connection: " + e),
                    this._connectionState = "Disconnected",
                    this.transport = void 0,
        ...
        async _getNegotiationResponse(e) {
            ...
            this._logger.log(Ft.Debug, `Sending negotiation request: ${r}.`);
            try {
                ...
                return (!n.negotiateVersion || n.negotiateVersion < 1) && (n.connectionToken = n.connectionId),
                    n.useStatefulReconnect && !0 !== this._options._useStatefulReconnect ? Promise.reject(new cn("Client didn't negotiate Stateful Reconnect but the server did.")) : n
            } catch (e) {
                let t = "Failed to complete negotiation with the server: " + e;
                return e instanceof tn && 404 === e.statusCode && (t += " Either this is not a SignalR endpoint or there is a proxy blocking the connection."),
                    this._logger.log(Ft.Error, t),
                    Promise.reject(new cn(t))
            }
        }
        ...
        async _createTransport(e, t, n, o) {
            ...
            if (this._isITransport(t))
                return this._logger.log(Ft.Debug, "Connection was provided an instance of ITransport, using that directly."),
                    this.transport = t,
            ...
            for (const n of s) {
                ...
                if (s instanceof Error)
                    ...
                    try {
                        ...
                        if (this._logger.log(Ft.Error, `Failed to start the transport '${n.transport}': ${e}`),
                            a = void 0,
                            i.push(new an(`${n.transport} failed: ${e}`, kn[n.transport])),
                            "Connecting" !== this._connectionState) {
                            const e = "Failed to select transport before stop() was called.";
                            return this._logger.log(Ft.Debug, e),
                                Promise.reject(new on(e))
                        }
                    }
                }
            }
            return i.length > 0 ? Promise.reject(new ln(`Unable to connect to the server with any of the available transports. ${i.join(" ")}`, i)) : Promise.reject(new Error("None of the transports supported by the client are supported by the server."))
        }
        _constructTransport(e) {
            switch (e) {
                case kn.WebSockets:
                    ...
                    return new xn(this._httpClient, this._accessTokenFactory, this._logger, this._options.logMessageContent, this._options.WebSocket, this._options.headers || {});
                case kn.ServerSentEvents:
        ...
        _resolveTransportOrError(e, t, n, o) {
            const r = kn[e.transport];
            if (null == r)
                return this._logger.log(Ft.Debug, `Skipping transport '${e.transport}' because it is not supported by this client.`),
                    new Error(`Skipping transport '${e.transport}' because it is not supported by this client.`);
            if (!function (e, t) {
                return !e || 0 != (t & e)
            }(t, r))
                return this._logger.log(Ft.Debug, `Skipping transport '${kn[r]}' because it was disabled by the client.`),
                    new sn(`'${kn[r]}' is disabled by the client.`, r);
            if (!(e.transferFormats.map((e => Tn[e])).indexOf(n) >= 0))
                return this._logger.log(Ft.Debug, `Skipping transport '${kn[r]}' because it does not support the requested transfer format '${Tn[n]}'.`),
                    new Error(`'${kn[r]}' does not support ${Tn[n]}.`);
            if (r === kn.WebSockets && !this._options.WebSocket || r === kn.ServerSentEvents && !this._options.EventSource)
                return this._logger.log(Ft.Debug, `Skipping transport '${kn[r]}' because it is not supported in your environment.'`),
                    new rn(`'${kn[r]}' is not supported in your environment.`, r);
            this._logger.log(Ft.Debug, `Selecting transport '${kn[r]}'.`);
            try {
                return this.features.reconnect = r === kn.WebSockets ? o : void 0,
        ...
        _stopConnection(e) {
            if (this._logger.log(Ft.Debug, `HttpConnection.stopConnection(${e}) called while in state ${this._connectionState}.`),
                this.transport = void 0,
                e = this._stopError || e,
                this._stopError = void 0,
                "Disconnected" !== this._connectionState) {
                if ("Connecting" === this._connectionState)
                    throw this._logger.log(Ft.Warning, `Call to HttpConnection.stopConnection(${e}) was ignored because the connection is still in the connecting state.`),
                ...
                if ("Disconnecting" === this._connectionState && this._stopPromiseResolver(),
                    e ? this._logger.log(Ft.Error, `Connection disconnected with error '${e}'.`) : this._logger.log(Ft.Information, "Connection disconnected."),
                    this._sendQueue && (this._sendQueue.stop().catch((e => {
                        this._logger.log(Ft.Error, `TransportSendQueue.stop() threw error '${e}'.`)
                    }
                    )),
                    ...
                    try {
                        ...
                        this._logger.log(Ft.Error, `HttpConnection.onclose(${e}) threw error '${t}'.`)
                    }
                }
            } else
                this._logger.log(Ft.Debug, `Call to HttpConnection.stopConnection(${e}) was ignored because the connection is already in the disconnected state.`)
        }
        _resolveUrl(e) {
            ...
            return t.href = e,
                this._logger.log(Ft.Information, `Normalizing '${e}' to '${t.href}'.`),
                t.href
        }
    ...
    class Mn {
        constructor(e) {
            this._transport = e,
                this._buffer = [],
                this._executing = !0,
                this._sendBufferedData = new Pn,
                this._transportResult = new Pn,
                this._sendLoopPromise = this._sendLoop()
        }
        send(e) {
            return this._bufferData(e),
                this._transportResult || (this._transportResult = new Pn),
        ...
        async _sendLoop() {
            for (; ;) {
                ...
                const t = "string" == typeof this._buffer[0] ? this._buffer.join("") : Mn._concatBuffers(this._buffer);
            ...
            for (const e of n) {
                ...
                switch (n.type) {
                    ...
                    case hn.Sequence:
                        ...
                        break;
                    default:
                        t.log(Ft.Information, "Unknown message type '" + n.type + "' ignored.");
                        continue
                }
                o.push(n)
            }
    ...
    class Bn {
        configureLogging(e) {
            if (Wt.isRequired(e, "logging"),
                ...
                this.logger = new Vt(t)
            } else
                this.logger = new Vt(e);
            return this
        }
        withUrl(e, t) {
            return Wt.isRequired(e, "url"),
        ...
        withHubProtocol(e) {
            return Wt.isRequired(e, "protocol"),
                this.protocol = e,
                this
        }
        withAutomaticReconnect(e) {
            ...
            return e ? Array.isArray(e) ? this.reconnectPolicy = new vn(e) : this.reconnectPolicy = e : this.reconnectPolicy = new vn,
                this
        }
        withServerTimeout(e) {
            return Wt.isRequired(e, "milliseconds"),
        ...
        build() {
            ...
            const t = new Nn(this.url, e);
            return gn.create(t, this.logger || $t.instance, this.protocol || new Un, this.reconnectPolicy, this._serverTimeoutInMilliseconds, this._keepAliveIntervalInMilliseconds, this._statefulReconnectBufferSize)
        }
    }
    var On;
    !function (e) {
    ...
    var qn = ("undefined" == typeof process || "never" !== (null === (Fn = null === process || void 0 === process ? void 0 : process.env) || void 0 === Fn ? void 0 : Fn.TEXT_ENCODING)) && "undefined" != typeof TextEncoder && "undefined" != typeof TextDecoder;
    function Jn(e) {
    ...
    var Kn = qn ? new TextEncoder : void 0
        , Vn = qn ? "undefined" != typeof process && "force" !== (null === ($n = null === process || void 0 === process ? void 0 : process.env) || void 0 === $n ? void 0 : $n.TEXT_ENCODING) ? 200 : 0 : Wn
        , Xn = (null == Kn ? void 0 : Kn.encodeInto) ? function (e, t, n) {
            Kn.encodeInto(e, t.subarray(n))
        }
            : function (e, t, n) {
                t.set(Kn.encode(e), n)
            }
    ...
    var Yn, Qn = qn ? new TextDecoder : null, Zn = qn ? "undefined" != typeof process && "force" !== (null === (Hn = null === process || void 0 === process ? void 0 : process.env) || void 0 === Hn ? void 0 : Hn.TEXT_DECODER) ? 200 : 0 : Wn, eo = function (e, t) {
        this.type = e,
            this.data = t
    }, to = (Yn = function (e, t) {
        ...
        decode: function (e) {
            var t = function (e) {
                ...
                switch (e.byteLength) {
                    ...
                    default:
                        throw new no("Unrecognized data size for timestamp (expected 4, 8, or 12): ".concat(e.length))
                }
            }(e);
                            ...
                            for (var o = e.length, r = n, i = 0; i < o;) {
                                ...
                                if (0 != (4294967168 & s)) {
                                    if (0 == (4294965248 & s))
                                        ...
                                        0 == (4294901760 & s) ? (t[r++] = s >> 12 & 15 | 224,
                                            t[r++] = s >> 6 & 63 | 128) : (t[r++] = s >> 18 & 7 | 240,
                                                t[r++] = s >> 12 & 63 | 128,
                                                t[r++] = s >> 6 & 63 | 128)
                                    }
                                    t[r++] = 63 & s | 128
    ...
    var co = function () {
        ...
        , uo = function (e) {
            return this instanceof uo ? (this.v = e,
                this) : new uo(e)
        }
        , po = new DataView(new ArrayBuffer(0))
        , fo = new Uint8Array(po.buffer)
        , go = function () {
            try {
                po.getInt8(0)
            } catch (e) {
            ...
            return e.prototype.reinitializeState = function () {
                            ...
                            return lo(this, (function (p) {
                                switch (p.label) {
                                    ...
                                    case 12:
                                        ...
                                        d = l.pos,
                                        u = l.totalPos,
                                        new RangeError("Insufficient data in parsing ".concat(ao(h), " at ").concat(u, " (").concat(d, " in the current buffer)"))
                                }
                            }
                            ))
                        }
                ...
                e.prototype.decodeMultiAsync = function (e, t) {
                    return function (n, o, r) {
                                ...
                                switch (d.label) {
                                    ...
                                    case 14:
                                        return d.trys.push([14, , 17, 18]),
                                            i && !i.done && (h = r.return) ? [4, uo(h.call(r))] : [3, 16];
                                    case 15:
                                        d.sent(),
                                            d.label = 16;
                                    case 16:
                        ...
                        function l(e, t) {
                            try {
                                (n = s[e](t)).value instanceof uo ? Promise.resolve(n.value.v).then(h, d) : u(a[0][2], n)
                            } catch (e) {
                                u(a[0][3], e)
                            }
                            var n
                ...
                e.prototype.doDecodeSync = function () {
                    e: for (; ;) {
                        ...
                        if (e >= 224)
                            ...
                            if (201 !== e)
                                throw new no("Unrecognized type byte: ".concat(ao(e)));
                            o = this.lookU32(),
                            ...
                            if (0 === i.type) {
                                ...
                                if (1 === i.type) {
                                    if ("string" != (s = typeof t) && "number" !== s)
                                        throw new no("The type of key must be string or number but " + typeof t);
                                    if ("__proto__" === t)
                                        throw new no("The key __proto__ is not allowed");
                                    i.key = t,
                                        i.type = 2;
                                    continue e
                                }
                ...
                e.prototype.readArraySize = function () {
                    ...
                    switch (e) {
                        ...
                        default:
                            if (e < 160)
                                return e - 144;
                            throw new no("Unrecognized array type byte: ".concat(ao(e)))
                    }
                }
                ,
                e.prototype.pushMapState = function (e) {
                    if (e > this.maxMapLength)
                        throw new no("Max length exceeded: map length (".concat(e, ") > maxMapLengthLength (").concat(this.maxMapLength, ")"));
                    this.stack.push({
                        type: 1,
                        size: e,
                        key: null,
                ...
                e.prototype.pushArrayState = function (e) {
                    if (e > this.maxArrayLength)
                        throw new no("Max length exceeded: array length (".concat(e, ") > maxArrayLength (").concat(this.maxArrayLength, ")"));
                    this.stack.push({
                        type: 0,
                        size: e,
                        array: new Array(e),
                ...
                e.prototype.decodeUtf8String = function (e, t) {
                    ...
                    if (e > this.maxStrLength)
                        throw new no("Max length exceeded: UTF-8 byte length (".concat(e, ") > maxStrLength (").concat(this.maxStrLength, ")"));
                    if (this.bytes.byteLength < this.pos + t + e)
                        throw mo;
                    var o, r = this.pos + t;
                    return o = this.stateIsMapKey() && (null === (n = this.keyDecoder) || void 0 === n ? void 0 : n.canBeCached(e)) ? this.keyDecoder.decode(this.bytes, r, e) : e > Zn ? function (e, t, n) {
                        var o = e.subarray(t, t + n);
                        return Qn.decode(o)
                    }(this.bytes, r, e) : Gn(this.bytes, r, e),
                        this.pos += t + e,
                        o
                }
                ,
                ...
                e.prototype.decodeBinary = function (e, t) {
                    if (e > this.maxBinLength)
                        throw new no("Max length exceeded: bin length (".concat(e, ") > maxBinLength (").concat(this.maxBinLength, ")"));
                ...
                e.prototype.decodeExtension = function (e, t) {
                    if (e > this.maxExtLength)
                        throw new no("Max length exceeded: ext length (".concat(e, ") > maxExtLength (").concat(this.maxExtLength, ")"));
    ...
    const bo = new Uint8Array([145, hn.Ping]);
    class _o {
        constructor(e) {
            this.name = "messagepack",
                this.version = 2,
                this.transferFormat = Tn.Binary,
                this._errorResult = 1,
                this._voidResult = 2,
                this._nonVoidResult = 3,
                e = e || {},
                this._encoder = new so(e.extensionCodec, e.context, e.maxDepth, e.initialBufferSize, e.sortKeys, e.forceFloat32, e.ignoreUndefined, e.forceIntegerToFloat),
                this._decoder = new yo(e.extensionCodec, e.context, e.maxStrLength, e.maxBinLength, e.maxArrayLength, e.maxMapLength, e.maxExtLength)
        }
        parseMessages(e, t) {
        ...
        _parseMessage(e, t) {
            ...
            switch (o) {
                ...
                default:
                    return t.log(Ft.Information, "Unknown message type '" + o + "' ignored."),
                        null
            }
        }
        ...
        _writeInvocation(e) {
            let t;
            return t = e.streamIds ? this._encoder.encode([hn.Invocation, e.headers || {}, e.invocationId || null, e.target, e.arguments, e.streamIds]) : this._encoder.encode([hn.Invocation, e.headers || {}, e.invocationId || null, e.target, e.arguments]),
                wo.write(t.slice())
        }
        _writeStreamInvocation(e) {
            let t;
            return t = e.streamIds ? this._encoder.encode([hn.StreamInvocation, e.headers || {}, e.invocationId, e.target, e.arguments, e.streamIds]) : this._encoder.encode([hn.StreamInvocation, e.headers || {}, e.invocationId, e.target, e.arguments]),
                wo.write(t.slice())
        }
        _writeStreamItem(e) {
            const t = this._encoder.encode([hn.StreamItem, e.headers || {}, e.invocationId, e.item]);
            return wo.write(t.slice())
        }
        _writeCompletion(e) {
            ...
            switch (t) {
                case this._errorResult:
                    n = this._encoder.encode([hn.Completion, e.headers || {}, e.invocationId, t, e.error]);
                    break;
                case this._voidResult:
                    n = this._encoder.encode([hn.Completion, e.headers || {}, e.invocationId, t]);
                    break;
                case this._nonVoidResult:
                    n = this._encoder.encode([hn.Completion, e.headers || {}, e.invocationId, t, e.result])
            }
            return wo.write(n.slice())
        }
        _writeCancelInvocation(e) {
            const t = this._encoder.encode([hn.CancelInvocation, e.headers || {}, e.invocationId]);
            return wo.write(t.slice())
        }
        _writeClose() {
            const e = this._encoder.encode([hn.Close, null]);
            return wo.write(e.slice())
        }
        _writeAck(e) {
            const t = this._encoder.encode([hn.Ack, e.sequenceId]);
            return wo.write(t.slice())
        }
        _writeSequence(e) {
            const t = this._encoder.encode([hn.Sequence, e.sequenceId]);
            return wo.write(t.slice())
        }
        _readHeaders(e) {
            const t = e[1];
    ...
    const So = "function" == typeof TextDecoder ? new TextDecoder("utf-8") : null
        , Co = So ? So.decode.bind(So) : function (e) {
            let t = 0;
            const n = e.length
                , o = []
                , r = [];
    ...
    class Ao {
        constructor(e) {
            this.batchData = e;
            const t = new Mo(e);
            this.arrayRangeReader = new Po(e),
                this.arrayBuilderSegmentReader = new Uo(e),
                this.diffReader = new Do(e),
                this.editReader = new xo(e, t),
                this.frameReader = new No(e, t)
        }
        updatedComponents() {
            return ko(this.batchData, this.batchData.length - 20)
        }
        referenceFrames() {
            return ko(this.batchData, this.batchData.length - 16)
        }
        disposedComponentIds() {
            return ko(this.batchData, this.batchData.length - 12)
        }
        disposedEventHandlerIds() {
            return ko(this.batchData, this.batchData.length - 8)
        }
    ...
    class Do {
        ...
        componentId(e) {
            return ko(this.batchDataUint8, e)
        }
        edits(e) {
            return e + 4
        }
    ...
    class xo {
        ...
        siblingIndex(e) {
            return ko(this.batchDataUint8, e + 4)
        }
        newTreeIndex(e) {
            return ko(this.batchDataUint8, e + 8)
        }
        moveToSiblingIndex(e) {
            return ko(this.batchDataUint8, e + 8)
        }
        removedAttributeName(e) {
            const t = ko(this.batchDataUint8, e + 12);
    ...
    class No {
        ...
        elementReferenceCaptureId(e) {
            const t = ko(this.batchDataUint8, e + 4);
            return this.stringReader.readString(t)
        }
        componentId(e) {
            return ko(this.batchDataUint8, e + 8)
        ...
        elementName(e) {
            const t = ko(this.batchDataUint8, e + 8);
            return this.stringReader.readString(t)
        }
        textContent(e) {
            const t = ko(this.batchDataUint8, e + 4);
        ...
        attributeEventHandlerId(e) {
            return Ro(this.batchDataUint8, e + 12)
        }
    }
    class Mo {
        constructor(e) {
            this.batchDataUint8 = e,
                this.stringTableStartIndex = ko(e, e.length - 4)
        }
        readString(e) {
            if (-1 === e)
                return null;
            {
                const n = ko(this.batchDataUint8, this.stringTableStartIndex + 4 * e)
                    , o = function (e, t) {
                        let n = 0
                            , o = 0;
                        for (let r = 0; r < 4; r++) {
    ...
    class Lo {
        ...
        async processBatch(e, t, n) {
            if (e < this.nextBatchId)
                return await this.completeBatch(n, e),
                    void this.logger.log(wt.Debug, `Batch ${e} already processed. Waiting for batch ${this.nextBatchId}.`);
            if (e > this.nextBatchId)
                return this.fatalError ? (this.logger.log(wt.Debug, `Received a new batch ${e} but errored out on a previous batch ${this.nextBatchId - 1}`),
                    void await n.send("OnRenderCompleted", this.nextBatchId - 1, this.fatalError.toString())) : void this.logger.log(wt.Debug, `Waiting for batch ${this.nextBatchId}. Batch ${e} not processed.`);
            try {
                this.nextBatchId++,
                    this.logger.log(wt.Debug, `Applying batch ${e}.`),
                    xe(On.Server, new Ao(t)),
        ...
        async completeBatch(e, t) {
            try {
                ...
                this.logger.log(wt.Warning, `Failed to deliver completion notification for render '${t}'.`)
            }
        }
    }
    let Bo = !1;
    ...
    class Fo {
        constructor(t, n, o, r) {
            this._firstUpdate = !0,
                ...
                this._options = o,
                this._logger = r,
                this._renderQueue = new Lo(this._logger),
        ...
        async startCore() {
            if (this._connection = await this.startConnection(),
                this._connection.state !== dn.Connected)
                return !1;
            const e = JSON.stringify(this._componentManager.initialComponents.map((e => Lt(e))));
            if (this._circuitId = await this._connection.invoke("StartCircuit", Ve.getBaseURI(), Ve.getLocationHref(), e, this._applicationState || ""),
                !this._circuitId)
                return !1;
        ...
        async startConnection() {
            ...
            const n = new _o;
            n.name = "blazorpack";
            const o = (new Bn).withUrl("_blazor").withHubProtocol(n);
            this._options.configureSignalR(o);
            const r = o.build();
            r.on("JS.AttachComponent", ((e, t) => Ae(On.Server, this.resolveElement(t), e, !1))),
                ...
                r.on("JS.BeginTransmitStream", (e => {
                    const t = new ReadableStream({
                        start: t => {
                            r.stream("SendDotNetStreamToJS", e).subscribe({
                                next: e => t.enqueue(e),
                                complete: () => t.close(),
                                error: e => t.error(e)
                            })
                ...
                r.on("JS.EndLocationChanging", yt._internal.navigationManager.endLocationChanging),
                r.onclose((e => {
            ...
            try {
                ...
                if (this.unhandledError(e),
                    ...
                    throw e;
                Oo(),
                    e.innerErrors && (e.innerErrors.some((e => "UnsupportedTransportError" === e.errorType && e.transport === kn.WebSockets)) ? this._logger.log(Ft.Error, "Unable to connect, please ensure you are using an updated browser that supports WebSockets.") : e.innerErrors.some((e => "FailedToStartTransportError" === e.errorType && e.transport === kn.WebSockets)) ? this._logger.log(Ft.Error, "Unable to connect, please ensure WebSockets are available. A VPN or proxy may be blocking the connection.") : e.innerErrors.some((e => "DisabledTransportError" === e.errorType && e.transport === kn.LongPolling)) && this._logger.log(Ft.Error, "Unable to initiate a SignalR connection to the server. This might be because the server is not configured to support WebSockets. For additional details, visit https://aka.ms/blazor-server-websockets-error."))
            }
            return (null === (t = null === (e = r.connection) || void 0 === e ? void 0 : e.features) || void 0 === t ? void 0 : t.inherentKeepAlive) && this._logger.log(Ft.Warning, "Failed to connect via WebSockets, using the Long Polling fallback transport. This may be due to a VPN or proxy blocking the connection. To troubleshoot this, visit https://aka.ms/blazor-server-using-fallback-long-polling."),
                r
        }
        async disconnect() {
            var e;
        ...
        async reconnect() {
            ...
            return this._connection.state === dn.Connected || (this._connection = await this.startConnection(),
                this._interopMethodsForReconnection && (k(On.Server, this._interopMethodsForReconnection),
        ...
        constructor(e, t, n, o) {
            ...
            r.addEventListener("click", (() => location.reload())),
                ...
                this.button.addEventListener("click", (async () => {
                    this.show();
                    try {
                        await yt.reconnect() || this.rejected()
                    } catch (e) {
    ...
    class jo {
        constructor(e, t, n) {
            this.dialog = e,
                ...
                this.document = n,
                this.document = n;
            const o = this.document.getElementById(jo.MaxRetriesId);
        ...
        update(e) {
            const t = this.document.getElementById(jo.CurrentAttemptId);
        ...
        removeClasses() {
            this.dialog.classList.remove(jo.ShowClassName, jo.HideClassName, jo.FailedClassName, jo.RejectedClassName)
        }
    }
    jo.ShowClassName = "components-reconnect-show",
        jo.HideClassName = "components-reconnect-hide",
        jo.FailedClassName = "components-reconnect-failed",
        jo.RejectedClassName = "components-reconnect-rejected",
        jo.MaxRetriesId = "components-reconnect-max-retries",
        jo.CurrentAttemptId = "components-reconnect-current-attempt";
    class zo {
        constructor(e, t, n) {
            this._currentReconnectionProcess = null,
                this._logger = e,
                this._reconnectionDisplay = t,
                this._reconnectCallback = n || yt.reconnect
        }
        onConnectionDown(e, t) {
            if (!this._reconnectionDisplay) {
                const t = document.getElementById(e.dialogId);
                this._reconnectionDisplay = t ? new jo(t, e.maxRetries, document) : new Wo(e.dialogId, e.maxRetries, document, this._logger)
            }
            this._currentReconnectionProcess || (this._currentReconnectionProcess = new qo(e, this._logger, this._reconnectCallback, this._reconnectionDisplay))
        }
        onConnectionUp() {
    ...
    class qo {
        ...
        async attemptPeriodicReconnection(e) {
            for (let t = 0; t < e.maxRetries; t++) {
                ...
                const n = 0 === t && e.retryIntervalMilliseconds > qo.MaximumFirstRetryInterval ? qo.MaximumFirstRetryInterval : e.retryIntervalMilliseconds;
    ...
    qo.MaximumFirstRetryInterval = 3e3;
    class Jo {
            ...
            await Promise.all(e.map((e => async function (e, n) {
                ...
                if (void 0 !== r) {
                    if (e.singleRuntime) {
                        ...
                        let h = n;
                        e.webRendererId === On.Server && c && (h = c),
                            e.webRendererId === On.WebAssembly && s && (h = s);
                        let d = o;
                        return e.webRendererId === On.Server && l && (d = l),
                            e.webRendererId === On.WebAssembly && a && (d = a),
                            i(e, h, d, t)
                    }
                    return function (e, t, n) {
                        var r;
                        ...
                        if (g && !s.enableClassicInitializers)
                            null === (r = e.logger) || void 0 === r || r.log(wt.Warning, `Initializer '${o}' will be ignored because multiple runtimes are available. use 'before(web|webAssembly|server)Start' and 'after(web|webAssembly|server)Started?' instead.)`);
                        else if (m)
                            return i(e, a, c, n);
                        if (function (e) {
    ...
    function nr(e) {
        ...
        return Qo = new Promise(or.bind(null, e)),
            Qo
    }
        ...
        const o = await async function (e) {
            if (e.initializers)
                return await Promise.all(e.initializers.beforeStart.map((t => t(e)))),
                    new Jo(!1, void 0, e.initializers.afterStarted, On.Server);
            const t = await fetch("_blazor/initializers", {
                ...
                , n = await t.json()
                , o = new Jo(!0, void 0, void 0, On.Server);
            return await o.importInitializersAsync(n, [e]),
                o
        }(Go);
        if (Vo = kt(document) || "",
            Yo = new _t(Go.logLevel),
            Xo = new Fo(e, Vo, Go, Yo),
            Yo.log(wt.Information, "Starting up Blazor server-side application."),
            yt.reconnect = async () => !(Xo.didRenderingFail() || !await Xo.reconnect() && (Yo.log(wt.Information, "Reconnection attempt to the circuit was rejected by the server. This may indicate that the associated state is no longer available on the server."),
                1)),
            yt.defaultReconnectionHandler = new zo(Yo),
            Go.reconnectionHandler = Go.reconnectionHandler || yt.defaultReconnectionHandler,
            yt._internal.navigationManager.listenForNavigationEvents(On.Server, ((e, t, n) => Xo.sendLocationChanged(e, t, n)), ((e, t, n, o) => Xo.sendLocationChanging(e, t, n, o))),
            yt._internal.forceCloseConnection = () => Xo.disconnect(),
            yt._internal.sendJSDataStream = (e, t, n) => Xo.sendJsDataStream(e, t, n),
            !await Xo.start())
            return Yo.log(wt.Error, "Failed to start the circuit."),
                void t();
        const r = () => {
            Xo.sendDisconnectBeacon()
        }
            ;
        yt.disconnect = r,
            ...
            Yo.log(wt.Information, "Blazor server-side application started."),
            o.invokeAfterStartedCallbacks(yt),
            t()
    }
    async function rr() {
        if (!Qo)
            throw new Error("Cannot start the circuit until Blazor Server has started.");
        return !(!Xo || Xo.isDisposedOrDisposing()) || (Zo ? await Zo : (await Qo,
            (!Xo || !Xo.didRenderingFail()) && (Xo && Xo.isDisposedOrDisposing() && (Vo = kt(document) || "",
                Xo = new Fo(Xo.getRootComponentManager(), Vo, Go, Yo)),
                Zo = Xo.start(),
                async function (e) {
                    await e,
                        Zo === e && (Zo = void 0)
    ...
    function ir(e) {
        if (Xo && !Xo.isDisposedOrDisposing())
            return Xo.updateRootComponents(e);
        !async function (e) {
            await Qo,
                await rr() && Xo.updateRootComponents(e)
        }(e)
    }
    function sr(e) {
        return er = e,
    ...
    var ar, cr;
    const lr = navigator
        , hr = lr.userAgentData && lr.userAgentData.brands
        , dr = hr && hr.length > 0 ? hr.some((e => "Google Chrome" === e.brand || "Microsoft Edge" === e.brand || "Chromium" === e.brand)) : window.chrome
        , ur = null !== (cr = null === (ar = lr.userAgentData) || void 0 === ar ? void 0 : ar.platform) && void 0 !== cr ? cr : navigator.platform;
    function pr(e) {
        return 0 !== e.debugLevel && (dr || navigator.userAgent.includes("Firefox"))
    }
    let fr, gr, mr, vr, yr, wr, br;
    ...
    const Ir = {
                            ...
                            , o = {
                                ...
                                onConfigLoaded: async n => {
                                    n.environmentVariables || (n.environmentVariables = {}),
                                        ...
                                        yt._internal.getApplicationEnvironment = () => n.applicationEnvironment,
                                        null == t || t(n),
                                        br = await async function (e, t) {
                                            var n, o, r;
                                            if (e.initializers)
                                                return await Promise.all(e.initializers.beforeStart.map((t => t(e)))),
                                                    new Jo(!1, void 0, e.initializers.afterStarted, On.WebAssembly);
                                            {
                                                const i = [e, null !== (o = null === (n = t.resources) || void 0 === n ? void 0 : n.extensions) && void 0 !== o ? o : {}]
                                                    , s = new Jo(!0, void 0, void 0, On.WebAssembly)
                                                    , a = Object.keys((null === (r = null == t ? void 0 : t.resources) || void 0 === r ? void 0 : r.libraryInitializers) || {});
                                                return await s.importInitializersAsync(a, i),
                                                    s
                                            }
                                        }(e, n)
                                }
                                ,
                                onDownloadResourceProgress: kr,
                                config: n,
        ...
        start: function () {
            return async function () {
                ...
                const { MONO: t, BINDING: n, Module: o, setModuleImports: r, INTERNAL: i, getConfig: s, invokeLibraryInitializers: a } = wr;
                mr = o,
                    fr = n,
                    gr = t,
                    yr = i,
                    function (e) {
                        const t = ur.match(/^Mac/i) ? "Cmd" : "Alt";
                        pr(e) && console.info(`Debugging hotkey: Shift+${t}+D (when application has focus)`),
                            document.addEventListener("keydown", (t => {
                                t.shiftKey && (t.metaKey || t.altKey) && "KeyD" === t.code && (pr(e) ? navigator.userAgent.includes("Firefox") ? async function () {
                    ...
                    yt.runtime = wr,
                    yt._internal.dotNetCriticalError = Ar,
                    r("blazor-internal", {
                        Blazor: {
                            _internal: yt._internal
                        }
                    });
                const c = await wr.getAssemblyExports("Microsoft.AspNetCore.Components.WebAssembly");
                return Object.assign(yt._internal, {
                    dotNetExports: {
                        ...c.Microsoft.AspNetCore.Components.WebAssembly.Services.DefaultWebAssemblyJSRuntime
                    }
                }),
                    vr = e.attachDispatcher({
                        beginInvokeDotNetFromJS: (e, t, n, o, r) => {
                            if (xr(),
                                !o && !t)
                                throw new Error("Either assemblyName or dotNetObjectId must have a non null value.");
                            const i = o ? o.toString() : t;
                            yt._internal.dotNetExports.BeginInvokeDotNet(e ? e.toString() : null, i, n, r)
                        }
                        ,
                        endInvokeJSFromDotNet: (e, t, n) => {
                            yt._internal.dotNetExports.EndInvokeJS(n)
                        }
                        ,
                        sendByteArray: (e, t) => {
                            yt._internal.dotNetExports.ReceiveByteArrayFromJS(e, t)
                        }
                        ,
                        invokeDotNetFromJS: (e, t, n, o) => (xr(),
                            yt._internal.dotNetExports.InvokeDotNet(e || null, t, null != n ? n : 0, o))
                    }),
                {
        ...
        callEntryPoint: async function () {
            try {
                await wr.runMain(wr.getConfig().mainAssemblyName, [])
            } catch (e) {
                console.error(e),
                    Oo()
            }
        ...
        toUint8Array: function (e) {
            const t = Dr(e)
                , n = Er(t)
                , o = new Uint8Array(n);
            return o.set(mr.HEAPU8.subarray(t + 4, t + 4 + n)),
                o
        },
        ...
        readStringField: function (e, t, n) {
            ...
            if (0 === o)
                return null;
            if (n) {
                const e = fr.unbox_mono_obj(o);
                return "boolean" == typeof e ? e ? "" : null : e
            }
            return fr.conv_string(o)
        },
        ...
        invokeWhenHeapUnlocked: function (e) {
            Cr ? Cr.enqueuePostReleaseAction(e) : e()
        }
    };
    function kr(e, t) {
        const n = e / t * 100;
    ...
    const Tr = ["DEBUGGING ENABLED"]
        , Rr = e => Tr.indexOf(e) < 0 && console.log(e)
        , Ar = e => {
    ...
    class Nr {
        ...
        release() {
            ...
            for (yr.mono_wasm_gc_unlock(),
                Cr = null; null === (e = this.postReleaseActions) || void 0 === e ? void 0 : e.length;)
                this.postReleaseActions.shift()(),
                    xr()
        }
        static create() {
            return yr.mono_wasm_gc_lock(),
                new Nr
        }
    }
    class Mr {
        constructor(e) {
            this.batchAddress = e,
                this.arrayRangeReader = Pr,
                this.arrayBuilderSegmentReader = Ur,
                this.diffReader = Lr,
                this.editReader = Br,
                this.frameReader = Or
        }
        updatedComponents() {
            return er.readStructField(this.batchAddress, 0)
        }
        referenceFrames() {
            return er.readStructField(this.batchAddress, Pr.structLength)
        }
        disposedComponentIds() {
            return er.readStructField(this.batchAddress, 2 * Pr.structLength)
        }
        disposedEventHandlerIds() {
            return er.readStructField(this.batchAddress, 3 * Pr.structLength)
        }
        updatedComponentsEntry(e, t) {
            return Fr(e, t, Lr.structLength)
        }
        referenceFramesEntry(e, t) {
            return Fr(e, t, Or.structLength)
        }
        disposedComponentIdsEntry(e, t) {
            const n = Fr(e, t, 4);
            return er.readInt32Field(n)
        }
        disposedEventHandlerIdsEntry(e, t) {
            const n = Fr(e, t, 8);
            return er.readUint64Field(n)
        }
    }
    const Pr = {
        structLength: 8,
        values: e => er.readObjectField(e, 0),
        count: e => er.readInt32Field(e, 4)
    }
        , Ur = {
            structLength: 12,
            values: e => {
                const t = er.readObjectField(e, 0)
                    , n = er.getObjectFieldsBaseAddress(t);
                return er.readObjectField(n, 0)
            }
            ,
            offset: e => er.readInt32Field(e, 4),
            count: e => er.readInt32Field(e, 8)
        }
        , Lr = {
            structLength: 4 + Ur.structLength,
            componentId: e => er.readInt32Field(e, 0),
            edits: e => er.readStructField(e, 4),
            editsEntry: (e, t) => Fr(e, t, Br.structLength)
        }
        , Br = {
            structLength: 20,
            editType: e => er.readInt32Field(e, 0),
            siblingIndex: e => er.readInt32Field(e, 4),
            newTreeIndex: e => er.readInt32Field(e, 8),
            moveToSiblingIndex: e => er.readInt32Field(e, 8),
            removedAttributeName: e => er.readStringField(e, 16)
        }
        , Or = {
            structLength: 36,
            frameType: e => er.readInt16Field(e, 4),
            subtreeLength: e => er.readInt32Field(e, 8),
            elementReferenceCaptureId: e => er.readStringField(e, 16),
            componentId: e => er.readInt32Field(e, 12),
            elementName: e => er.readStringField(e, 16),
            textContent: e => er.readStringField(e, 16),
            markupContent: e => er.readStringField(e, 16),
            attributeName: e => er.readStringField(e, 16),
            attributeValue: e => er.readStringField(e, 24, !0),
            attributeEventHandlerId: e => er.readUint64Field(e, 8)
        };
    function Fr(e, t, n) {
        return er.getArrayEntryPtr(e, t, n)
    }
    class $r {
        constructor(e) {
    ...
    let Hr, Wr, jr, zr, qr, Jr = !1, Kr = !1, Vr = !0, Xr = !1;
    const Gr = new Promise((e => {
        qr = e
    }
    ));
    let Yr;
    const Qr = new Promise((e => {
        Yr = e
    }
    ));
    let Zr;
    function ei(e) {
        ...
        return zr = new Promise(ti.bind(null, e)),
            zr
    }
    async function ti(e, t, n) {
        ...
        !function (e) {
            ...
            D = (e, n, o) => {
                ((e, t, n) => {
                    const o = De(e);
                    (null == o ? void 0 : o.eventDelegator.getHandler(t)) && Ir.invokeWhenHeapUnlocked(n)
                }
                )(e, n, (() => t(e, n, o)))
            }
        }(),
            yt._internal.applyHotReload = (e, t, n, o) => {
                vr.invokeDotNetStaticMethod("Microsoft.AspNetCore.Components.WebAssembly", "ApplyHotReloadDelta", e, t, n, o)
            }
            ,
            yt._internal.getApplyUpdateCapabilities = () => vr.invokeDotNetStaticMethod("Microsoft.AspNetCore.Components.WebAssembly", "GetApplyUpdateCapabilities"),
            yt._internal.invokeJSFromDotNet = oi,
            yt._internal.invokeJSJson = ri,
            yt._internal.endInvokeDotNetFromJS = ii,
            yt._internal.receiveWebAssemblyDotNetDataStream = si,
            yt._internal.receiveByteArray = ai;
        const r = sr(Ir);
        yt.platform = r,
            yt._internal.renderBatch = (e, t) => {
                const n = Ir.beginHeapLock();
                try {
                    xe(e, new Mr(t))
                } finally {
                    n.release()
            ...
            ,
            yt._internal.navigationManager.listenForNavigationEvents(On.WebAssembly, (async (e, t, n) => {
                await vr.invokeDotNetStaticMethodAsync("Microsoft.AspNetCore.Components.WebAssembly", "NotifyLocationChanged", e, t, n)
            }
            ), (async (e, t, n, o) => {
                const r = await vr.invokeDotNetStaticMethodAsync("Microsoft.AspNetCore.Components.WebAssembly", "NotifyLocationChangingAsync", t, n, o);
                yt._internal.navigationManager.endLocationChanging(e, r)
            }
            ));
        const i = new $r(e);
        let s;
        yt._internal.registeredComponents = {
            ...
            yt._internal.getPersistedState = () => Tt(document, Et) || "",
            yt._internal.getInitialComponentsUpdate = () => Qr,
            yt._internal.updateRootComponents = e => {
                var t;
                return null === (t = yt._internal.dotNetExports) || void 0 === t ? void 0 : t.UpdateRootComponentsCore(e)
            }
            ,
            yt._internal.endUpdateRootComponents = t => {
                var n;
                return null === (n = e.onAfterUpdateRootComponents) || void 0 === n ? void 0 : n.call(e, t)
            }
            ,
            yt._internal.attachRootComponentToElement = (e, t, n) => {
                const o = i.resolveRegisteredElement(e);
                o ? Ae(n, o, t, !1) : function (e, t, n) {
                    const o = "::before";
                    let r = !1;
                    if (e.endsWith("::after"))
                        e = e.slice(0, -7),
        ...
        r.callEntryPoint(),
            br.invokeAfterStartedCallbacks(yt),
            Kr = !0,
            t()
    }
    function ni() {
        return null != jr || (jr = (async () => {
            await Wr;
            const e = null != Hr ? Hr : {}
                , t = null == Hr ? void 0 : Hr.configureRuntime;
            e.configureRuntime = e => {
                null == t || t(e),
                    Xr && e.withEnvironmentVariable("__BLAZOR_WEBASSEMBLY_WAIT_FOR_ROOT_COMPONENTS", "true")
            }
                ,
                await Ir.load(e, qr),
                Jr = !0
    ...
    function oi(t, n, o, r) {
        const i = Ir.readStringField(t, 0)
            , s = Ir.readInt32Field(t, 4)
            , a = Ir.readStringField(t, 8)
            , c = Ir.readUint64Field(t, 20);
        if (null !== a) {
            const e = Ir.readUint64Field(t, 12);
            if (0 !== e)
                return vr.beginInvokeJSFromDotNet(e, i, a, s, c),
                    0;
            {
                const e = vr.invokeJSFromDotNet(i, a, s, c);
                return null === e ? 0 : fr.js_string_to_mono_string(e)
            }
        }
        {
                ...
                case e.JSCallResultType.JSStreamReference:
                    {
                        const n = e.createJSStreamReference(t)
                            , o = JSON.stringify(n);
                        return fr.js_string_to_mono_string(o)
                    }
    ...
    function ri(e, t, n, o, r) {
        return 0 !== r ? (vr.beginInvokeJSFromDotNet(r, e, o, n, t),
            null) : vr.invokeJSFromDotNet(e, o, n, t)
    }
    function ii(e, t, n) {
        vr.endInvokeDotNetFromJS(e, t, n)
    }
    function si(e, t, n, o) {
        !function (e, t, n, o, r) {
            let i = vt.get(t);
            ...
            r ? (i.error(r),
                vt.delete(t)) : 0 === o ? (i.close(),
                    vt.delete(t)) : i.enqueue(n.length === o ? n : n.subarray(0, o))
        }(vr, e, t, n, o)
    }
    function ai(e, t) {
        vr.receiveByteArray(e, t)
    }
    function ci(e, t) {
    ...
    class ui {
        static create(e, t, n) {
            return 0 === t && n === e.length ? e : new ui(e, t, n)
        }
        constructor(e, t, n) {
            this.source = e,
                this.startIndex = t,
    ...
    function gi(e, t) {
        ...
        r && (W(o, !0),
            W(t, !0)),
            r ? (i = new Ei(o),
                s = new Ei(t)) : (i = o.childNodes,
                    s = t.childNodes),
            e instanceof Node || (i = new Ci(i, e));
        const a = function (e, t, n) {
            const o = function (e, t, n) {
                const o = Math.min(e.length, t.length);
                for (let r = 0; r < o; r++)
                    if (n(e.item(r), t.item(r)) !== hi.None)
                        return r;
                return o
            }(e, t, n);
            ...
            const r = function (e, t, n, o, r) {
                let i = e.length - 1
                    , s = t.length - 1
                    , a = 0;
                for (; i >= n && s >= o && r(e.item(i), t.item(s)) === hi.None;)
                    i--,
                        s--,
                        a++;
                return a
                ...
                , i = function (e) {
                    ...
                    for (; o > 0 || r > 0;) {
                        const t = 0 === o ? di.Insert : 0 === r ? di.Delete : e[o][r];
                        switch (n.unshift(t),
                        t) {
                            case di.Keep:
                            case di.Update:
                    ...
                    for (let a = 1; a <= i; a++)
                        for (let i = 1; i <= s; i++) {
                            ...
                            h < l && h < c ? (o[a][i] = h,
                                r[a][i] = s === hi.None ? di.Keep : di.Update) : l < c ? (o[a][i] = l,
                                    r[a][i] = di.Insert) : (o[a][i] = c,
                                        r[a][i] = di.Delete)
                        }
                    return r
                }(e = ui.create(e, o, e.length - o - r), t = ui.create(t, o, t.length - o - r), n));
            return {
                skipCount: o,
                edits: i
            }
        ...
        let c, l;
        r ? (c = new Si(i.item(0)),
            l = new Si(s.item(0))) : (c = new _i(i.item(0)),
                l = new _i(s.item(0)));
        for (let e = 0; e < a.skipCount; e++)
            mi(c.current, l.current),
                c.advance(),
                l.advance();
        if (a.edits) {
            const t = a.edits
                    ...
                    case di.Delete:
                        {
                            ...
                            c.advance(),
                                h = e,
                                Z(d = o) ? q(h, W(document.createDocumentFragment()), 0) : d.removeChild(h);
                            break
                        }
                    case di.Insert:
                        {
                    ...
                    !function (e, t) {
                        if (!function (e, t) {
                            ...
                            for (const n of t.attributes) {
                                ...
                                t ? (t.value !== n.value && ci(e, n),
                                    r.delete(t.name)) : ci(e, n)
                            }
    ...
    function yi(e, t, n) {
        ...
        for (; o.nextNode();) {
            ...
            e && (null == pi || pi.registerComponent(e))
        }
    }
    function wi(e, t) {
        ...
        switch (e.nodeType) {
            case Node.TEXT_NODE:
                return e.textContent === t.textContent ? hi.None : hi.Some;
            case Node.COMMENT_NODE:
                {
                    const n = X(e)
                        , o = X(t);
                    return n || o ? n && o && Bt(n, o) ? hi.None : hi.Infinite : e.textContent === t.textContent ? hi.None : hi.Some
                }
            case Node.ELEMENT_NODE:
                return e.tagName !== t.tagName ? hi.Infinite : (n = t,
                    e.getAttribute(li) !== n.getAttribute(li) ? hi.Infinite : hi.None);
            case Node.DOCUMENT_TYPE_NODE:
                return hi.None;
            default:
                return hi.Infinite
    ...
    const Ii = "text/html; blazor-enhanced-nav=on";
    let ki, Ti, Ri, Ai = location.href;
    function Di(e) {
        Ti = e,
            document.addEventListener("click", Ni),
            document.addEventListener("submit", Pi),
    ...
    ///<summary>
    /// Evénément d'écoute du click et du submit 
    ///</summary >
    function Ni(e) {
        $e() || e.target instanceof Element && !function (e) {
    ...
    async function Ui(e, t, n, o) {
        ...
        if (await async function (e, t, n, o) {
            ...
            try {
                ...
                let o = !0;
                await r.body.pipeThrough(new TextDecoderStream).pipeThrough(function (e) {
                    let t = "";
            ...
            const i = !(null == n ? void 0 : n.method) || "get" === n.method
            ...
            (t.redirected || o) && ((o ? "get" === o : i) ? history.replaceState(null, "", t.url) : t.url !== location.href && history.pushState(null, "", t.url),
                e = t.url);
            const c = t.headers.get("blazor-enhanced-nav-redirect-location");
            if (c)
                return void location.replace(c);
            t.redirected || i || !a || (function (e) {
                const t = new URL(e.url)
                    , n = new URL(Ai);
                return t.protocol === n.protocol && t.host === n.host && t.port === n.port && t.pathname === n.pathname
            }(t) ? location.href !== Ai && history.pushState(null, "", Ai) : s = `Cannot perform enhanced form submission that changes the URL (except via a redirection), because then back/forward would not work. Either remove this form's 'action' attribute, or change its method to 'get', or do not mark it as enhanced.\nOld URL: ${location.href}\nNew URL: ${t.url}`),
                Ai = t.url;
            const l = t.headers.get("content-type");
            if ((null == l ? void 0 : l.startsWith("text/html")) && r) {
                const e = (new DOMParser).parseFromString(r, "text/html");
                fi(document, e),
                    Ti.documentUpdated()
            } else
                (null == l ? void 0 : l.startsWith("text/")) && r ? Li(r) : a || r ? i ? Bi(e) : Li(`Error: ${n.method} request to ${e} returned non-HTML content of type ${l || "unspecified"}.`) : Li(`Error: ${t.status} ${t.statusText}`)
        }
        )),
            !r.aborted) {
            const t = e.indexOf("#");
            ...
            if (Ri = !1,
                Ti.enhancedNavigationCompleted(),
                s)
                throw new Error(s)
        }
    }
            ...
            null === (e = t.parentNode) || void 0 === e || e.removeChild(t),
                t.childNodes.forEach((e => {
                    if (e instanceof HTMLTemplateElement) {
                        ...
                        if (t)
                            "true" !== e.getAttribute("enhanced-nav") && ki || function (e, t) {
                                const n = function (e) {
                                    const t = `bl:${e}`
                            ...
                            switch (e.getAttribute("type")) {
                                case "redirection":
                                    const t = Fe(e.content.textContent)
                                        , n = "form-post" === e.getAttribute("from");
                                    "true" === e.getAttribute("enhanced") && Me(t) ? Ui(t, !1, void 0, n ? "post" : "get") : n ? t !== location.href && location.assign(t) : location.replace(t);
                                    break;
                                case "error":
                                    Li(e.content.textContent || "Error")
                            }
                    }
                }
                ))
    ...
    class Hi {
        ...
        onAfterRenderBatch(e) {
            e === On.Server && this.circuitMayHaveNoRootComponents()
        }
        onDocumentUpdated() {
            this.rootComponentsMayRequireRefresh()
        }
        ...
        startCircutIfNotStarted() {
            return void 0 === Qo ? nr(this) : !Xo || Xo.isDisposedOrDisposing() ? rr() : void 0
        }
        async startWebAssemblyIfNotStarted() {
            this.startLoadingWebAssemblyIfNotStarted(),
                void 0 === zr && await ei(this)
        }
        ...
        circuitMayHaveNoRootComponents() {
            if (this.rendererHasExistingOrPendingComponents(On.Server, "server", "auto"))
            ...
            void 0 === this._circuitInactivityTimeoutId && (this._circuitInactivityTimeoutId = setTimeout((() => {
                this.rendererHasExistingOrPendingComponents(On.Server, "server", "auto") || (async function () {
                    await (null == Xo ? void 0 : Xo.dispose())
                }(),
        ...
        refreshRootComponents(e) {
            ...
            for (const [e, n] of t) {
                ...
                e === On.Server ? ir(o) : this.updateWebAssemblyRootComponents(o)
            }
            this.circuitMayHaveNoRootComponents()
        }
        updateWebAssemblyRootComponents(e) {
            Vr ? (Yr(e),
                Vr = !1) : function (e) {
                    ...
                    if (!yt._internal.updateRootComponents)
                        throw new Error("Blazor WebAssembly has not initialized.");
                    Kr ? yt._internal.updateRootComponents(e) : async function (e) {
                        if (await zr,
                            !yt._internal.updateRootComponents)
                            throw new Error("Blazor WebAssembly has not initialized.");
                        yt._internal.updateRootComponents(e)
                    }(e)
                }(e)
        ...
        getAutoRenderMode() {
            return this.rendererHasExistingOrPendingComponents(On.WebAssembly, "webassembly") ? "webassembly" : this.rendererHasExistingOrPendingComponents(On.Server, "server") ? "server" : Jr ? "webassembly" : this._didWebAssemblyFailToLoadQuickly ? "server" : null
        }
        determinePendingOperation(e) {
            if (t = e.descriptor,
                document.contains(t.start)) {
                if (void 0 === e.assignedRendererId) {
                    if (Ri || "loading" === document.readyState)
                        return null;
                    const t = this.resolveRendererIdForDescriptor(e.descriptor);
                    return null === t ? null : T(t) ? (be(e.descriptor.start, !0),
                        e.assignedRendererId = t,
                        e.uniqueIdAtLastUpdate = e.descriptor.uniqueId,
                    {
                        type: "add",
                        ssrComponentId: e.ssrComponentId,
                        marker: Lt(e.descriptor)
                    }) : null
                }
                return T(e.assignedRendererId) ? e.uniqueIdAtLastUpdate === e.descriptor.uniqueId ? null : (e.uniqueIdAtLastUpdate = e.descriptor.uniqueId,
                {
                    type: "update",
                    ssrComponentId: e.ssrComponentId,
                    marker: Lt(e.descriptor)
            ...
            return e.hasPendingRemoveOperation ? null : void 0 === e.assignedRendererId ? (this.unregisterComponent(e),
                null) : T(e.assignedRendererId) ? (be(e.descriptor.start, !1),
    ...
    function Ji(e) {
        ...
        qi = !0,
            null !== (t = (e = e || {}).logLevel) && void 0 !== t || (e.logLevel = wt.Error),
            yt._internal.isBlazorWeb = !0,
            yt._internal.hotReloadApplied = () => {
                Be() && Oe(location.href, !0)
            }
            ,
            zi = new Hi(null !== (o = null === (n = null == e ? void 0 : e.ssr) || void 0 === n ? void 0 : n.circuitInactivityTimeoutMs) && void 0 !== o ? o : 2e3);
        const i = ji.create(yt)
            , s = {
                documentUpdated: () => {
                    zi.onDocumentUpdated(),
                        i.dispatchEvent("enhancedload", {})
                }
                ,
                enhancedNavigationCompleted() {
                    zi.onEnhancedNavigationCompleted()
                }
            };
        return pi = zi,
            function (e, t) {
                Oi = t,
                    (null == e ? void 0 : e.disableDomPreservation) && (Fi = !1),
                    customElements.define("blazor-ssr-end", $i)
            }(null == e ? void 0 : e.ssr, s),
            (null === (r = null == e ? void 0 : e.ssr) || void 0 === r ? void 0 : r.disableDomPreservation) || Di(s),
            "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", Ki.bind(null, e)) : Ki(e),
            Promise.resolve()
    }
    ///<summary>
    /// Evénement d'écoute du DOMContentLoaded
    ///</summary>
    function Ki(e) {
        const t = $o((null == e ? void 0 : e.circuit) || {});
        e.circuit = t;
        const n = async function (e, t) {
            var n;
            const o = Tt(document, It, "initializers");
            if (!o)
                return new Jo(!1, t);
            const r = null !== (n = JSON.parse(atob(o))) && void 0 !== n ? n : []
                , i = new Jo(!1, t);
            return await i.importInitializersAsync(r, [e]),
                i
        }(e, new _t(t.logLevel));
        tr(Vi(n, t)),
            function (e) {
            ...
            }(Vi(n, (null == e ? void 0 : e.webAssembly) || {})),
            function (e) {
                const t = bi(document);
                for (const e of t)
                    null == pi || pi.registerComponent(e)
            }(),
            zi.onDocumentUpdated(),
            async function (e) {
                const t = await e;
                await t.invokeAfterStartedCallbacks(yt)
            }(n)
    }
    ...
    yt.start = Ji,
        window.DotNet = e,
        document && document.currentScript && "false" !== document.currentScript.getAttribute("autostart") && Ji()
}
)();
